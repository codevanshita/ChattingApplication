...
import java.net.*;  // Correct for networking (ServerSocket, Socket, etc.)
import java.io.*;
...
public class Server implements ActionListener {
    ...
    Server(){  //constructor
      ...
      ImageIcon myPicIcon = new ImageIcon(getClass().getResource("/icons/mypic.jpeg"));
Image myPicImage = myPicIcon.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
ImageIcon myPicFinal = new ImageIcon(myPicImage);

JLabel myPicLabel = new JLabel(myPicFinal);
myPicLabel.setBounds(40, 10, 50, 50);  // (x, y, width, height)
p1.add(myPicLabel);
...
ImageIcon i7 = new ImageIcon(getClass().getResource("/icons/video.png"));
       ...
       JLabel name = new JLabel("Vanshita");
    ...
    public void actionPerformed(ActionEvent ae){
     ...
     //text box will be empty after writing the msg
        ...
        new Server(); //class object
         try {
             ...
             while(true){
                 ...
                 dout = new DataOutputStream(s.getOutputStream()); // for sending and receiving the msg
